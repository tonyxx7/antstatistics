...
public class AntStatisticsLogger extends DefaultLogger {
	...
	private static final String HISTORY_FILENAME_DEFAULT = "history.xml";
	private static final String HISTORY_FILENAME_PROPERTY_NAME = "antstatistics.history.file";
	...
	private String chartImageFilename;
	private static final String CHART_IMAGE_FILENAME_DEFAULT = "statistics.png";
	private static final String CHART_IMAGE_FILENAME_PROPERTY_NAME = "antstatistics.chart.file";
	...
	private final static Comparator<ProjectPerformance> PROJECT_PERFORMANCE_DATE_COMPERATOR = new Comparator<ProjectPerformance>() {
		...
		public int compare(
			...
			if (project1 == null || project2 == null
				...
				return -1
						* project1.getStartDate().compareTo(project2.getStartDate());
			}
		}
	};
	...
	private Map<Date, Map<String, Long>> createChartData(
	...
	private void initializeProperties(BuildEvent buildEvent) {
		...
		chartImageFilename = getProperty(buildEvent, CHART_IMAGE_FILENAME_PROPERTY_NAME, CHART_IMAGE_FILENAME_DEFAULT);
		historyFileName = getProperty(buildEvent, HISTORY_FILENAME_PROPERTY_NAME, HISTORY_FILENAME_DEFAULT);
	...
	private ProjectPerformances readProjectPerformances() {
		...
		File file = new File(dataDirectory, historyFileName);
	...
	private void saveChartImage(JFreeChart chart) {
		File imageFile = new File(dataDirectory, chartImageFilename);
